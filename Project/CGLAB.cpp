...
void introScreen()
{
    ...
    displayRasterText(-500, 490, 0.0, (char*)"THAPAR INSTITUTE OF ENGINEERING AND TECHNOLOGY");
    glColor3f(1.0, 1.0, 1.0);
    displayRasterText(-500, 385, 0.0, (char*)"DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING");
    ...
    glColor3f(1.0, 1.0, 1.0);
    displayRasterText(-900, -50, 0.0, (char*)" Harsh Kashyap [101917088]");
    displayRasterText(-300, -50, 0.0, (char*)" Nikhil Singla [101917095]");
    displayRasterText(400, -50, 0.0, (char*)" Ritik Raj [101917101]");
    glColor3f(1.0, 0.0, 0.0);
    displayRasterText(-400, -150, 0.0, (char*)"SUBMITTED TO:           Ms Namrata Dimari");
    glColor3f(1.0, 1.0, 1.0);
    displayRasterText(500, -200, 0.0, (char*)"");
    glColor3f(1.0, 0.0, 0.0);
    displayRasterText(-250, -400, 0.0, (char*)"Academic Year 2021-2022");
    glColor3f(1.0, 1.0, 1.0);
